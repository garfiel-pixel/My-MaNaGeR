...
const INLINE_SCRIPT_HASHES = [
  ...
  "'sha256-4SRT/j2HQAmoqRpFY7U/lfiEhQiYIjOw9Xmp2HPAeKs='", // app.html (launcher + 2026-08-15: rail-head hamburger toggle + pill toast(); 2026-08-16: dash-cleanup — card CTA 'Unlocked, open' + 'Not published. Visitors can't see this yet' + rail empty state + 'Unlocked, opening…' + toast 'Preference saved. This device uses CSS glass.' — no em-dashes)
  "'sha256-qbHZHLyhdEDRwWrA8/I8ty4xIjUv+L/+Y6/0cIXdkJo='", // admin.html (early-apply theme snippet)
  "'sha256-+mv0OCfSHOu9loUrwKtLEGtS9/+z2wdIJSbXChNvwPE='", // admin.html (2026-08-15: pill toast() + rail sign-in/customize + Import Project + Publish to Cloud + cloud-code adoption + sign-in routing from publish; 2026-08-16: dash-cleanup — every visible toast/hint/confirm copy de-dashed: clipboard/publish/import/owner-code messages read as flowing sentences)

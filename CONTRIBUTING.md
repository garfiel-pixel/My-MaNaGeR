...
- **Types:** `feat`, `fix`, `chore`, `test`, `docs`, `refactor`, `perf`,
  `build`, `ci`, `revert`
- **Subject:** imperative mood, ≤ 72 characters, no trailing period, no emoji,
  no SCREAMING-CASE titles. Say what the change does, briefly — this is a
...
| `test: prefs round-trip E2E harness for /api/cloud/prefs/theme` | `more stuff` |
| `docs: add conventional commit convention` | `feat: THEME-SYSTEM + MOBILE-DRAWER + CHANGELOG-UI SWEEP — huge one-line dump of every detail` |

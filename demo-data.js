...
(function() {
  ...
  window.MMGR_DEMO_FILLED = {
    ...
    tasks: [
      { id: 'T001', name: 'Pre-Construction Planning', start: '2025-01-06', end: '2025-02-28', status: 'completed', leadDays: 0, phase: 'planning', assignee: 'Marcus Webb', dependencies: [], progress: 100 },
      { id: 'T002', name: 'Permit Applications', start: '2025-01-13', end: '2025-03-14', status: 'completed', leadDays: 14, phase: 'planning', assignee: 'Diana Chen', dependencies: ['T001'], progress: 100 },
      { id: 'T003', name: 'Structural Assessment', start: '2025-02-03', end: '2025-03-28', status: 'completed', leadDays: 21, phase: 'planning', assignee: 'James Okonkwo', dependencies: ['T001'], progress: 100 },
      { id: 'T004', name: 'Steel Procurement', start: '2025-02-17', end: '2025-06-13', status: 'completed', leadDays: 42, phase: 'procurement', assignee: 'Rachel Torres', dependencies: ['T003'], progress: 100 },
      { id: 'T005', name: 'Elevator Equipment Order', start: '2025-03-03', end: '2025-07-25', status: 'completed', leadDays: 35, phase: 'procurement', assignee: 'Kevin Patel', dependencies: ['T002'], progress: 100 },
      { id: 'T006', name: 'Tenant Relocation (Floors 1-4)', start: '2025-03-17', end: '2025-04-25', status: 'completed', leadDays: 14, phase: 'demolition', assignee: 'Marcus Webb', dependencies: ['T002'], progress: 100 },
      { id: 'T007', name: 'Demolition Floors 1-4', start: '2025-04-28', end: '2025-06-06', status: 'completed', leadDays: 0, phase: 'demolition', assignee: 'Luis Ramirez', dependencies: ['T006'], progress: 100 },
      { id: 'T008', name: 'Seismic Retrofit Floors 1-4', start: '2025-06-09', end: '2025-09-05', status: 'completed', leadDays: 14, phase: 'structural', assignee: 'James Okonkwo', dependencies: ['T004', 'T007'], progress: 100 },
      { id: 'T009', name: 'MEP Rough-In Floors 1-4', start: '2025-07-07', end: '2025-10-03', status: 'in-progress', leadDays: 7, phase: 'mechanical', assignee: 'Sarah Kim', dependencies: ['T008'], progress: 72 },
      { id: 'T010', name: 'Tenant Relocation (Floors 5-8)', start: '2025-06-16', end: '2025-07-25', status: 'completed', leadDays: 14, phase: 'demolition', assignee: 'Marcus Webb', dependencies: ['T008'], progress: 100 },
      { id: 'T011', name: 'Demolition Floors 5-8', start: '2025-07-28', end: '2025-09-05', status: 'completed', leadDays: 0, phase: 'demolition', assignee: 'Luis Ramirez', dependencies: ['T010'], progress: 100 },
      { id: 'T012', name: 'Seismic Retrofit Floors 5-8', start: '2025-09-08', end: '2025-12-05', status: 'in-progress', leadDays: 14, phase: 'structural', assignee: 'James Okonkwo', dependencies: ['T004', 'T011'], progress: 45 },
      { id: 'T013', name: 'MEP Rough-In Floors 5-8', start: '2025-10-06', end: '2026-01-09', status: 'not-started', leadDays: 7, phase: 'mechanical', assignee: 'Sarah Kim', dependencies: ['T012'], progress: 0 },
      { id: 'T014', name: 'Elevator Modernization (Cab 1)', start: '2025-08-04', end: '2025-10-31', status: 'completed', leadDays: 21, phase: 'mechanical', assignee: 'Kevin Patel', dependencies: ['T005'], progress: 100 },
      { id: 'T015', name: 'Elevator Modernization (Cab 2)', start: '2025-10-06', end: '2025-12-26', status: 'in-progress', leadDays: 21, phase: 'mechanical', assignee: 'Kevin Patel', dependencies: ['T014'], progress: 60 },
      { id: 'T016', name: 'Elevator Modernization (Cab 3)', start: '2026-01-05', end: '2026-03-27', status: 'not-started', leadDays: 21, phase: 'mechanical', assignee: 'Kevin Patel', dependencies: ['T015'], progress: 0 },
      { id: 'T017', name: 'Lobby Redesign Construction', start: '2025-09-08', end: '2025-12-19', status: 'in-progress', leadDays: 28, phase: 'finishes', assignee: 'Diana Chen', dependencies: ['T008', 'T007'], progress: 55 },
      { id: 'T018', name: 'Facade Restoration', start: '2025-10-06', end: '2026-02-27', status: 'not-started', leadDays: 21, phase: 'exterior', assignee: 'Luis Ramirez', dependencies: ['T012'], progress: 0 },
      { id: 'T019', name: 'Roof Membrane Replacement', start: '2025-11-03', end: '2026-01-16', status: 'not-started', leadDays: 14, phase: 'exterior', assignee: 'Rachel Torres', dependencies: ['T004'], progress: 0 },
      { id: 'T020', name: 'Fire Alarm Upgrade', start: '2025-12-01', end: '2026-03-06', status: 'not-started', leadDays: 14, phase: 'safety', assignee: 'Sarah Kim', dependencies: ['T009'], progress: 0 },
      { id: 'T021', name: 'Tenant Relocation (Floors 9-12)', start: '2025-12-08', end: '2026-01-16', status: 'not-started', leadDays: 14, phase: 'demolition', assignee: 'Marcus Webb', dependencies: ['T012'], progress: 0 },
      { id: 'T022', name: 'Demolition Floors 9-12', start: '2026-01-19', end: '2026-02-27', status: 'not-started', leadDays: 0, phase: 'demolition', assignee: 'Luis Ramirez', dependencies: ['T021'], progress: 0 },
      { id: 'T023', name: 'Seismic Retrofit Floors 9-12', start: '2026-03-02', end: '2026-05-08', status: 'not-started', leadDays: 14, phase: 'structural', assignee: 'James Okonkwo', dependencies: ['T004', 'T022'], progress: 0 },
      { id: 'T024', name: 'MEP Rough-In Floors 9-12', start: '2026-03-16', end: '2026-05-22', status: 'not-started', leadDays: 7, phase: 'mechanical', assignee: 'Sarah Kim', dependencies: ['T023'], progress: 0 },
      { id: 'T025', name: 'Interior Finishes Floors 1-4', start: '2025-10-06', end: '2025-12-19', status: 'not-started', leadDays: 14, phase: 'finishes', assignee: 'Diana Chen', dependencies: ['T009'], progress: 0 },
      { id: 'T026', name: 'Interior Finishes Floors 5-8', start: '2026-01-12', end: '2026-03-27', status: 'not-started', leadDays: 14, phase: 'finishes', assignee: 'Diana Chen', dependencies: ['T013'], progress: 0 },
      { id: 'T027', name: 'Interior Finishes Floors 9-12', start: '2026-04-06', end: '2026-06-05', status: 'not-started', leadDays: 14, phase: 'finishes', assignee: 'Diana Chen', dependencies: ['T024'], progress: 0 },
      { id: 'T028', name: 'Commissioning and Testing', start: '2026-05-11', end: '2026-06-05', status: 'not-started', leadDays: 7, phase: 'closeout', assignee: 'Sarah Kim', dependencies: ['T020', 'T024', 'T027'], progress: 0 },
      { id: 'T029', name: 'Punch List and Final Inspection', start: '2026-06-08', end: '2026-06-26', status: 'not-started', leadDays: 0, phase: 'closeout', assignee: 'Marcus Webb', dependencies: ['T028'], progress: 0 },
      { id: 'T030', name: 'Project Closeout and Handover', start: '2026-06-29', end: '2026-06-30', status: 'not-started', leadDays: 0, phase: 'closeout', assignee: 'Marcus Webb', dependencies: ['T029'], progress: 0 }
    ],
    resources: [
    ...
    baseline: {
      tasks: [
        { id: 'T001', start: '2025-01-06', end: '2025-02-28' },
        { id: 'T002', start: '2025-01-13', end: '2025-03-14' },
        { id: 'T008', start: '2025-06-09', end: '2025-09-05' },
        { id: 'T012', start: '2025-09-08', end: '2025-12-05' },
        { id: 'T023', start: '2026-03-02', end: '2026-05-08' },
        { id: 'T030', start: '2026-06-29', end: '2026-06-30' }
      ]
    },
    ...
    wxWindow: { start: '2025-11-01', end: '2026-03-31', bufferDays: 14 },
    weatherLog: [

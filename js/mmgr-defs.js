...
(function(ns) {
 ...
 { term: 'Parallel Tasks', group: 'Scheduling',
 meaning: 'Tasks scheduled to run during the same stretch of days, at the same time, without one waiting for the other.',
 why: 'The WBS marks them with a parallel badge - hover it to see exactly which tasks run alongside and the dates they share, so a client asking "when will this be done?" gets the full picture.' },
